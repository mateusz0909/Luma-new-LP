    ...
    <article className="pt-24 pb-20 px-4 sm:px-6 md:px-12 max-w-4xl mx-auto text-white leading-relaxed font-sans">
      ...
      <section className="space-y-8 mb-14 text-sm sm:text-base font-serif text-white/80 leading-relaxed">
        <div>
          ...
          <p className="mb-4">
            Hi, I’m <strong>Mateusz Byrtus</strong>, an independent software developer and longtime breathwork practitioner.
          </p>
          <p className="mb-4">
            Like thousands of others practicing the Wim Hof Method daily, I became increasingly frustrated with commercial mobile apps that charge steep annual subscriptions ($40–$80/year), bombard users with paywalls, require mandatory cloud accounts, or fail to offer a proper standalone Apple Watch experience.
          </p>
          <p>
            Breathwork is a fundamental human birthright. You shouldn't need a monthly subscription just to count 30 breaths and track a retention stopwatch. I built <strong>Luma</strong> with a simple promise: <em>Zero ads, zero subscriptions, zero tracking, and pure focus forever.</em>
          </p>
        </div>

        <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/10 font-sans">
      ...
      <footer className="pt-8 border-t border-white/10 flex items-center justify-between font-mono text-xs text-white/60">
        ...
        <span>Developer: Mateusz Byrtus</span>
      </footer>
